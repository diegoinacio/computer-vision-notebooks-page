export const HEADER = {
  ...
  description: `An authorial collection of <span class="computer-vision">Computer Vision</span> fundamentals and useful <span class="notebooks">python notebooks</span>.`,
};

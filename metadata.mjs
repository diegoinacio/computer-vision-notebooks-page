export const HEADER = {
  ...
  description: `An authorial set of fundamental <span class="stripe">Python recipes</span> on <strong>Computer Vision</strong> and <strong>Digital Image Processing</strong>.`,
};

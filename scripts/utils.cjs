...
function generate_tags(notebook, data) {
  ...
  return [
    ...
    `<meta property="og:url" content="https://diegoinacio.github.io/computer-vision-notebooks-page/pages/${notebook}.html">`,
    `<meta name="title" property="og:title" content="${data.title} >> Computer Vision Notebooks | Diego Inácio">`,
    `<meta name="description" property="og:description" content="${data.description}">`,
    `<meta name="image" property="og:image" content="https://diegoinacio.github.io/computer-vision-notebooks-page/images/thumb_${notebook}.jpg">`,
